  ...
  return (
    <Router>
      <div className="max-w-4xl mx-auto pb-32">
        ...
        <header className="text-center mb-6 md:mb-8 pb-4 md:pb-6" style={{borderBottomColor: COLORS.gold, borderBottomWidth: '4px'}}>
          <div className="flex justify-between items-start">
            ...
            <button
              ...
              style={{backgroundColor: COLORS.redDark, borderColor: COLORS.gold, borderWidth: '1px', color: COLORS.gold}}
        ...
        {/* Page Content */}
        <Routes>
          <Route path="/board" element={<Board token={token} onQuestUpdate={handleQuestUpdate} />} />
