...
function PlaygroundQuestCard({ quest, fontClassName }: QuestCardProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute top-0 left-0 w-8 h-8 border-l-4 border-t-4 opacity-60"
        style={{ borderColor: colors.border }}
      />
      <div
        className="absolute top-0 right-0 w-8 h-8 border-r-4 border-t-4 opacity-60"
        style={{ borderColor: colors.border }}
      />
      <div
        className="absolute bottom-0 left-0 w-8 h-8 border-l-4 border-b-4 opacity-60"
        style={{ borderColor: colors.border }}
      />
      <div
        className="absolute bottom-0 right-0 w-8 h-8 border-r-4 border-b-4 opacity-60"
        style={{ borderColor: colors.border }}
      />
      ...
      {/* Description */}
      <p className="text-sm mb-4 opacity-90" style={{ color: COLORS.parchment }}>
        {quest.description}
      </p>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <ul className="space-y-2 text-sm" style={{ color: COLORS.parchment }}>
            <li>
              • <strong>Hybrid approach:</strong> CSS borders + decorative corner elements
            </li>
            <li>
              • <strong>Parchment texture:</strong> Subtle SVG pattern overlay
            </li>
            <li>
              • <strong>Glowing borders:</strong> Box shadow matching quest type color
            </li>
            <li>
              • <strong>Type-based styling:</strong> Gold (standard), Purple (bounty), Red
              (corrupted)
            </li>
            <li>
              • <strong>Status indicators:</strong> Quest type badge, completion status, due dates
            </li>
            <li>
              • <strong>Responsive:</strong> Mobile-first vertical layout
            </li>
          </ul>
        </div>
      </div>
