...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 flex justify-around items-center py-3 md:py-4 border-t" style={{backgroundColor: COLORS.dark, borderTopColor: COLORS.gold, borderTopWidth: '2px'}}>
      {navItems.map(item => (
        <Link
          key={item.path}
          to={item.path}
